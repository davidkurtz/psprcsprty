...
AND r.jobinstance IN(
  ...
  FROM psprcsrqst r1
  WHERE r1.runstatus = '9'
  AND r1.enddttm>r1.begindttm
  --and r1.begindttm BETWEEN ROUND(r1.begindttm)-5/24 AND ROUND(r1.begindttm)+5/24 --run between 7pm and 5am
  and r1.oprid IN('startup') --limit to overnight batch operator IDs
  ...
  and r1.runcntlid like 'GPPDPRUN_CALCUL____'
...
from sysadm.ps_xx_gfcprcsprty p
  left outer join r 
